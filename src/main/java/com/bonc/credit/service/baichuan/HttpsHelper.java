...
import com.bonc.credit.service.zhongchengxin.MyHostnameVerifier;
...
public class HttpsHelper {
    ...
    public static String httPost(String httpsUrl, String xmlStr) {
        ...
        try {
            ...
            System.out.println("xmlStrGBK:"+xmlStr.getBytes("gbk"));
            System.out.println("xmlStrUTF-8:"+xmlStr.getBytes("UTF-8"));
